...
import { IStratusObjects, IStratusBucket, IStratusCorsRes, IStratusObjectDetails, IStratusPagedObjectOptions, IStratusPreSignedUrlOptions, IStratusPutObjectOptions, IStratusUnzipRes, IStratusObjectRenameRes, IStratusMultipartSummaryRes, IStratusInitiateUpload, IStratusUnzipStatus, IStratusObjectCopyRes, IStratusInitiateObjectOptions, IStratusUploadPartOptions, IStratusPresignedUrlRes, IStratusCompleteUploadOptions } from '../utils/pojo/stratus';
...
export declare class Bucket {
     ...
     */
    completeMultipartUpload(key: string, uploadId: string, options?: IStratusCompleteUploadOptions): Promise<boolean>;
    /**
