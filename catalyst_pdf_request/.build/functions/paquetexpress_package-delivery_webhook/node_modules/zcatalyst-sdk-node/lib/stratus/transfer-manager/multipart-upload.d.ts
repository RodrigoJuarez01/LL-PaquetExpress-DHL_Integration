...
import { IStratusCompleteUploadOptions, IStratusMultipartSummaryRes, IStratusUploadPartOptions } from '../../utils/pojo/stratus';
export declare class MultipartUpload {
     ...
     */
    uploadPart(body: Stream | Buffer, partNumber: number, options?: IStratusUploadPartOptions): Promise<boolean>;
    /**
     ...
     */
    completeUpload(options?: IStratusCompleteUploadOptions): Promise<boolean>;
    /**
