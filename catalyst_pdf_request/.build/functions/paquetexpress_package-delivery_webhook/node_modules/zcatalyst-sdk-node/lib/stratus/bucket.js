...
class Bucket {
    ...
    getObject(key, { range, versionId } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let signParam = (yield __classPrivateFieldGet(this, _Bucket_util, "f").getBucketSignature());
            if (signParam !== undefined) {
                url += '/_signed';
                this.auth = false;
            }
            else {
                signParam = { orgType: '70' };
            }
            const request = {
                method: REQ_METHOD.get,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (__classPrivateFieldGet(this, _Bucket_util, "f")._getUserType() !== 'admin' && __classPrivateFieldGet(this, _Bucket_util, "f")._getUserScope() !== 'admin') {
                ...
                const request = {
                    method: REQ_METHOD.delete,
                    url: url + `/${encodeURI(key)}`,
                    qs: Object.assign(Object.assign(Object.assign({}, (ttl ? { ttl } : {})), (versionId ? { versionId } : { deleteAllVersions: 'true' })), { orgType: '70' }),
                    type: "json" /* RequestType.JSON */,
                    expecting: "json" /* ResponseType.JSON */,
                    catalyst: false,
                    external: true,
    ...
    uploadPart(key, uploadId, body, partNumber, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const length = options === null || options === void 0 ? void 0 : options.contentLength;
            let url = this.bucketDetails.bucket_url;
            ...
            if (signParam !== undefined) {
                url += '/_signed';
                this.auth = false;
                param = Object.assign(Object.assign({}, param), signParam);
            }
            else {
                param = Object.assign(Object.assign({}, param), { orgType: 70 });
            }
            const request = {
                method: REQ_METHOD.put,
                url: url + `/${encodeURI(key)}`,
                ...
                qs: param,
                type: "raw" /* RequestType.RAW */,
                headers: Object.assign({ compress: (options === null || options === void 0 ? void 0 : options.compress) || 'false', overwrite: ((options === null || options === void 0 ? void 0 : options.overwrite) || false) + '' }, (length ? { 'content-length': length + '' } : {})),
                expecting: "json" /* ResponseType.JSON */,
                catalyst: false,
                external: true,
                auth: this.auth,
     ...
     */
    completeMultipartUpload(key, uploadId, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let url = this.bucketDetails.bucket_url;
            let signParam = (yield __classPrivateFieldGet(this, _Bucket_util, "f").getBucketSignature());
            if (signParam !== undefined) {
            ...
            const request = {
                ...
                headers: { overwrite: ((options === null || options === void 0 ? void 0 : options.overwrite) || false) + '' },
                type: "json" /* RequestType.JSON */,
                expecting: "json" /* ResponseType.JSON */,
                catalyst: false,
                auth: this.auth,
